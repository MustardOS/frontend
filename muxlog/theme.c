...
void apply_theme() {
    struct big background_elements[] = {
            {ui_scrLog,   theme.SYSTEM.BACKGROUND},
    ...
    struct small background_alpha_elements[] = {
            {ui_scrLog, theme.SYSTEM.BACKGROUND_ALPHA}
    };
    ...
    struct big default_elements[] = {
            {ui_txtMessage, theme.VERBOSE_BOOT.TEXT}
    };
    ...
    struct small text_default_alpha_elements[] = {
            {ui_txtMessage, theme.VERBOSE_BOOT.TEXT_ALPHA}
    };
