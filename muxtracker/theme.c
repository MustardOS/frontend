...
void apply_theme() {
    struct big background_elements[] = {
            {ui_scrTracker,     theme.SYSTEM.BACKGROUND},
    ...
    struct small background_alpha_elements[] = {
            {ui_scrTracker,     theme.SYSTEM.BACKGROUND_ALPHA},
    ...
    struct big default_elements[] = {
            ...
            {ui_lblRomMessage,        theme.LIST_DEFAULT.TEXT},
            ...
            {ui_lblPreviewHeader,     theme.HELP.TITLE},
            {ui_lblInfoHeader,        theme.HELP.TITLE},
    ...
    struct big border_elements[] = {
            ...
            {ui_pnlHelpExtra,   theme.HELP.BORDER},
            {ui_pnlInfo,        theme.HELP.BORDER},
    ...
    struct small text_default_alpha_elements[] = {
            ...
            {ui_lblRomMessage,   theme.LIST_DEFAULT.TEXT_ALPHA},
    ...
    struct small radius_elements[] = {
            ...
            {ui_imgPreviewImage, theme.IMAGE_PREVIEW.RADIUS},
    ...
    struct big image_recolour_elements[] = {
            ...
            {ui_imgPreviewImage, theme.IMAGE_PREVIEW.RECOLOUR},
    };
    ...
    struct small image_recolour_alpha_elements[] = {
            ...
            {ui_imgPreviewImage, theme.IMAGE_PREVIEW.RECOLOUR_ALPHA},
    };
    ...
    struct small font_pad_top_list_elements[] = {
            {ui_lblRomMessage, theme.FONT.LIST_PAD_TOP},
    };
    ...
    struct small font_pad_bottom_list_elements[] = {
            {ui_lblRomMessage, theme.FONT.LIST_PAD_BOTTOM},
    };
