...
lv_obj_t * ui_pnlPreviewImage;
lv_obj_t * ui_imgPreviewImage;
lv_obj_t * ui_pnlInfo;
lv_obj_t * ui_lblInfoHeader;
...
void ui_init(void)
{
    ui_scrTracker_screen_init();
    ui____initial_actions0 = lv_obj_create(NULL);
    lv_disp_load_scr(ui_scrTracker);
}
