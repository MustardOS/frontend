...
// LVGL version: 8.3.6
// Project name: muxtracker

#include "ui.h"

void ui_scrTracker_screen_init(void)
{
    ui_scrTracker = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_scrTracker, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_scrTracker, lv_color_hex(0x100808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_scrTracker, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_scrTracker, &ui_font_NotoSans, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_pnlWall = lv_obj_create(ui_scrTracker);
    ...
    lv_label_set_text(ui_lblTitle, "ACTIVITY TRACKER");
    ...
    ui_pnlFooter = lv_obj_create(ui_scrTracker);
    ...
    lv_obj_set_width(ui_lblNavMenuGlyph, 25);
    ...
    ui_lblRomMessage = lv_label_create(ui_scrTracker);
    lv_obj_set_width(ui_lblRomMessage, 640);
    lv_obj_set_height(ui_lblRomMessage, 28);
    lv_obj_set_align(ui_lblRomMessage, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblRomMessage, "Nothing Played Yet...");
    lv_obj_add_flag(ui_lblRomMessage, LV_OBJ_FLAG_HIDDEN | LV_OBJ_FLAG_FLOATING);     /// Flags
    lv_obj_set_scroll_dir(ui_lblRomMessage, LV_DIR_HOR);
    lv_obj_set_style_text_color(ui_lblRomMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblRomMessage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_lblRomMessage, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_lblRomMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_lblRomMessage, lv_color_hex(0x100808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui_lblRomMessage, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_lblRomMessage, LV_GRAD_DIR_HOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_lblRomMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_lblRomMessage, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui_lblRomMessage, LV_BORDER_SIDE_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_lblRomMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_lblRomMessage, lv_color_hex(0xF8E008), LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_text_opa(ui_lblRomMessage, 255, LV_PART_MAIN | LV_STATE_FOCUSED);

    ui_pnlMessage = lv_obj_create(ui_scrTracker);
    ...
    ui_pnlHelp = lv_obj_create(ui_scrTracker);
    ...
    ui_lblHelpDescription = lv_label_create(ui_pnlHelpMessage);
    ...
    lv_label_set_long_mode(ui_lblHelpDescription, LV_LABEL_LONG_DOT);
    lv_label_set_text(ui_lblHelpDescription, "");
    lv_label_set_recolor(ui_lblHelpDescription, "true");
    lv_obj_set_scrollbar_mode(ui_lblHelpDescription, LV_SCROLLBAR_MODE_ON);
    lv_obj_set_scroll_dir(ui_lblHelpDescription, LV_DIR_VER);
    ...
    lv_obj_set_width(ui_lblPreviewHeader, 515);
    ...
    lv_label_set_text(ui_lblPreviewHeader, "Press  ✁  to switch to preview image");
    lv_label_set_recolor(ui_lblPreviewHeader, "true");
    ...
    lv_obj_set_flex_align(ui_pnlHelpPreview, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START);
    lv_obj_add_flag(ui_pnlHelpPreview, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_pnlHelpPreview, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_pnlHelpPreview, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_left(ui_pnlHelpPreview, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_pnlHelpPreview, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_pnlHelpPreview, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_pnlHelpPreview, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_long_mode(ui_lblHelpPreviewHeader, LV_LABEL_LONG_SCROLL_CIRCULAR);
    lv_label_set_text(ui_lblHelpPreviewHeader, "%helpheader%");
    ...
    ui_pnlPreviewImage = lv_obj_create(ui_pnlHelpPreview);
    lv_obj_set_width(ui_pnlPreviewImage, 515);
    lv_obj_set_height(ui_pnlPreviewImage, 275);
    lv_obj_set_align(ui_pnlPreviewImage, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_pnlPreviewImage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_pnlPreviewImage, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui_pnlPreviewImage, LV_BORDER_SIDE_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(ui_pnlPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_imgPreviewImage = lv_img_create(ui_pnlPreviewImage);
    lv_img_set_src(ui_imgPreviewImage, &ui_img_nothing_png);
    lv_obj_set_width(ui_imgPreviewImage, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_imgPreviewImage, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_imgPreviewImage, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_imgPreviewImage, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_imgPreviewImage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_imgPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_imgPreviewImage, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_imgPreviewImage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_imgPreviewImage, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_imgPreviewImage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_imgPreviewImage, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui_imgPreviewImage, LV_BORDER_SIDE_FULL, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_imgPreviewImage, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_imgPreviewImage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_imgPreviewImage, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_imgPreviewImage, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_x(ui_imgPreviewImage, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui_imgPreviewImage, 6, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_pnlInfo = lv_obj_create(ui_pnlHelpPreview);
    lv_obj_set_width(ui_pnlInfo, 515);
    lv_obj_set_height(ui_pnlInfo, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_pnlInfo, LV_ALIGN_CENTER);
    lv_obj_set_flex_flow(ui_pnlInfo, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(ui_pnlInfo, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START);
    lv_obj_clear_flag(ui_pnlInfo, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_pnlInfo, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_pnlInfo, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_pnlInfo, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui_pnlInfo, LV_BORDER_SIDE_TOP, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_pnlInfo, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_pnlInfo, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_pnlInfo, 14, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_pnlInfo, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui_pnlInfo, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(ui_pnlInfo, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_lblInfoHeader = lv_label_create(ui_pnlInfo);
    lv_obj_set_width(ui_lblInfoHeader, 515);
    lv_obj_set_height(ui_lblInfoHeader, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_lblInfoHeader, LV_ALIGN_CENTER);
    lv_label_set_long_mode(ui_lblInfoHeader, LV_LABEL_LONG_CLIP);
    lv_label_set_text(ui_lblInfoHeader, "Press  ✁  to switch to information");
    lv_label_set_recolor(ui_lblInfoHeader, "true");
    lv_obj_set_style_text_color(ui_lblInfoHeader, lv_color_hex(0xF7E318), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblInfoHeader, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_pnlProgress = lv_obj_create(ui_scrTracker);
