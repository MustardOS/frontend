...
void ui_scrTweakAdvanced_screen_init(void)
{
    ...
    lv_obj_set_x(ui_lblVerbose, 100);
    lv_obj_set_y(ui_lblVerbose, -70);
    lv_obj_set_align(ui_lblVerbose, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblVerbose, "Verbose Boot");
    ...
    lv_obj_set_x(ui_icoVerbose, 100);
    lv_obj_set_y(ui_icoVerbose, -70);
    ...
    lv_obj_set_style_pad_left(ui_icoVerbose, 12, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_icoVerbose, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_icoVerbose, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_left(ui_icoLED, 12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_droVerbose, 100);
    lv_obj_set_y(ui_droVerbose, -30);
    ...
    lv_obj_set_style_radius(ui_droVerbose, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
