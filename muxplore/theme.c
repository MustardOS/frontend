...
void apply_theme() {
    ...
    struct small background_alpha_elements[] = {
            {ui_scrExplore,            theme.SYSTEM.BACKGROUND_ALPHA},
            ...
            {ui_pnlHelpPreview,        theme.HELP.BACKGROUND_ALPHA},
    ...
    struct big default_elements[] = {
            ...
            {ui_lblExploreMessage,         theme.LIST_DEFAULT.TEXT},
            ...
            {ui_lblPreviewHeaderGlyph,     theme.NAV.A.GLYPH},
    ...
    struct big border_elements[] = {
            ...
            {ui_pnlHelpPreview,        theme.HELP.BORDER},
    ...
    struct small border_alpha_elements[] = {
            ...
            {ui_pnlHelpPreview,        theme.HELP.BORDER_ALPHA},
    ...
    struct small text_default_alpha_elements[] = {
            ...
            {ui_lblPreviewHeaderGlyph,     theme.NAV.A.GLYPH_ALPHA},
    ...
    struct small font_pad_top_footer_elements[] = {
            ...
            {ui_lblPreviewHeader,          theme.FONT.FOOTER_PAD_TOP},
            {ui_lblHelpPreviewInfoMessage, theme.FONT.FOOTER_PAD_TOP},
    };
    ...
    struct small font_pad_bottom_footer_elements[] = {
            ...
            {ui_lblPreviewHeader,          theme.FONT.FOOTER_PAD_BOTTOM},
            {ui_lblHelpPreviewInfoMessage, theme.FONT.FOOTER_PAD_BOTTOM},
    };
    for (size_t i = 0;
    ...
    struct small font_pad_top_footer_icon_elements[] = {
            ...
            {ui_lblPreviewHeaderGlyph,   theme.FONT.FOOTER_ICON_PAD_TOP},
            {ui_lblHelpPreviewInfoGlyph, theme.FONT.FOOTER_ICON_PAD_TOP},
    };
    for (size_t i = 0;
    ...
    struct small font_pad_bottom_footer_icon_elements[] = {
            ...
            {ui_lblPreviewHeaderGlyph,   theme.FONT.FOOTER_ICON_PAD_BOTTOM},
            {ui_lblHelpPreviewInfoGlyph, theme.FONT.FOOTER_ICON_PAD_BOTTOM},
    };
    for (size_t i = 0;
    ...
    struct small font_pad_top_list_elements[] = {
            {ui_lblExploreMessage, theme.FONT.LIST_PAD_TOP},
    };
    ...
    struct small font_pad_bottom_list_elements[] = {
            {ui_lblExploreMessage, theme.FONT.LIST_PAD_BOTTOM},
    };
