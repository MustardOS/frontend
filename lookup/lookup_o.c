...
const lookup_internal_name lookup_o_table[] = {
    ...
    {"oldsplus", "Oriental Legend 2 (Korea) / Xiyou Shi E Zhuan Qunmo Luanwu (World, China, Japan, Hong Kong, Taiwan) "
                 "(ver. 205) [Oriental Ex]"},
    {"oldsplus203", "Oriental Legend 2 (Korea) / Xiyou Shi E Zhuan Qunmo Luanwu (World, China, Japan, Hong Kong, "
                    "Taiwan) (ver. 203) [Oriental Ex]"},
