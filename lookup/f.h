...
const lookup_internal_name lookup_f_table[] = {
    ...
    {"fantasy", "Fantasy (US)"},
    {"fantasyg", "Fantasy (Germany, set 1)"},
    ...
    {"fantzn2xps2", "Fantasy Zone II - The Tears of Opa-Opa (System 16C, PS2 data file)"},
    {"fantznps2", "Fantasy Zone (System 16B, PS2 data file)"},
    {"fantznta", "Fantasy Zone Time Attack (System 16B, PS2 data file)"},
    {"fantzone", "Fantasy Zone (Japan New Ver.)"},
    {"fantzone1", "Fantasy Zone (unprotected)"},
    {"fantzonee", "Fantasy Zone (FD1089B 317-0016)"},
    {"fantzoneno", "Fantasy Zone (New, Oversea, PS2)"},
    {"fantzonenu", "Fantasy Zone (New, US Rev.a, PS2)"},
    ...
    {"fatfury2a", "Fatal Fury 2 / Garou Densetsu 2 - arata-naru tatakai (NGM-047)"},
    {"fatfury3", "Fatal Fury 3 - Road to the Final Victory / Garou Densetsu 3 - Haruka-naru Tatakai"},
    {"fatfury3a", "Fatal Fury 3 - Road to the Final Victory / Garou Densetsu 3 - haruka-naru tatakai (NGM-069 ~ "
                  "NGH-069) (alternate set)"},
    {"fax", "Fax"},
    {"fax2", "FAX 2"},
    ...
    {"fenix", "Fenix (Orio bootleg of Phoenix)"},
    ...
    {"ffightu2", "Final Fight (USA, set 3)"},
    ...
    {"fitegolf2", "Fighting Golf (US, Ver 2)"},
    ...
    {"flickyg", "Flicky (128k Version, System 2, 315-5051, alt graphics)"},
    {"flickyo", "Flicky (64k Ver.)"},
    {"flickys1", "Flicky (64k Version, 315-5051, set 2)"},
    {"flickys2", "Flicky (128k Version, not encrypted)"},
    {"flickys2g", "Flicky (128k Version, System 2, not encrypted, alt graphics)"},
