...
const lookup_internal_name lookup_b_table[] = {
    ...
    {"bagmans3", "Bagman (Stern Electronics, revision A3)"},
    ...
    {"beast", "Shadow of the Beast (Neo Geo demo)"},
    ...
    {"bgareggaz", "Battle Garegga Zakk version (Europe / USA / Japan / Asia) (Sat Feb 3 1996)"},
    ...
    {"bloodbrom", "Blood Bros. (Modular System)"},
    ...
    {"blox", "Blox (v2.0)"},
    {"blox16b", "Bloxeed (System 16B, PS2 data file)"},
    ...
    {"bnstars", "Vs. Janshi Brandnew Stars (Ver 1.1, MegaSystem32 Version)"},
    ...
    {"bub68705a", "Bubble Bobble (boolteg with 68705, set 2)"},
