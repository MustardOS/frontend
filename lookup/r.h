...
const lookup_internal_name lookup_r_table[] = {
    {"r2dtank", "R2D Tank"},
    ...
    {"rallych", "Rally Chase (Neo CD conversion)"},
    ...
    {"redclasht", "Red Clash (Tehkan, set 1)"},
    {"redclashta", "Red Clash (Tehkan, set 2)"},
    ...
    {"robocopb2", "Robocop (Red Corporation World bootleg)"},
    {"robocopi", "Robocop (FMV Demo)"},
    ...
    {"robokidj2", "Atomic Robo-kid (Japan, Type-2, set 2)"},
    {"robokidj3", "Atomic Robo-kid (Japan)"},
    {"robotbwl", "Robot Bowl"},
    ...
    {"ryourano", "VS Mahjong Otome Ryouran (revision 1)"},
