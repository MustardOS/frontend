...
const lookup_internal_name lookup_m_table[] = {
    ...
    {"mainevt2", "The Main Event (version F)"},
    ...
    {"markham", "Markham"},
    {"mars", "Mars"},
    {"martmast", "Martial Masters / Xing Yi Quan (ver. 104, 102, 102US)"},
    {"martmast102c", "Martial Masters / Xing Yi Quan (ver. 102, 101, 101CN)"},
    {"martmast103c", "Martial Masters / Xing Yi Quan (ver. 103, 102, 101CN)"},
    {"martmast104c", "Martial Masters / Xing Yi Quan (ver. 104, 102, 101CN)"},
    {"martmastc", "Martial Masters (ver. 104, 102, 101CN)"},
    {"martmastc102", "Martial Masters (ver. 102, 101, 101CN)"},
    {"martmastc103", "Martial Masters (V103, 102, 101, China)"},
    {"martmasttw", "Martial Masters (V102, 101, 101, Taiwan)"},
    {"maruchan", "Maru-Chan de Goo!"},
    {"marukin", "Super Marukin-Ban"},
    {"marukina", "Super Marukin-Ban (Japan 901017)"},
    ...
    {"matrimbh", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (Enable Hidden Characters V2)"},
    ...
    {"meijinsn", "Meijinsen (set 1)"},
    {"meijinsna", "Meijinsen (set 2)"},
    ...
    {"mercsc", "Senjo no Ookami II (T-Chi)"},
    ...
    {"misncrft", "Mission Craft (version 2.7)"},
    ...
    {"missw02d", "Miss World 2002 (Daigom license)"},
    ...
    {"mkyawdim5", "Mortal Kombat (Yawdim bootleg, set 5)"},
    ...
    {"mooncrs5", "Moon Cresta (bootleg set 4)"},
    ...
    {"moshougi", "Shougi no Tatsujin - Master of Shougi"},
    ...
    {"mototoura", "MotoTour / Zippy Race (Assa version of Tecfri license)"},
    ...
    {"mpangjd", "Mighty! Pang (Japan 001011 Phoenix Edition) (bootleg)"},
    ...
    {"mslug2unity", "Metal Slug 2 - Super Vehicle-001/II Unity (Added Timer Ver. 2021-01-22)"},
    {"mslug3", "Metal Slug 3"},
    {"mslug3a", "Metal Slug 3 (NGM-2560, earlier)"},
    {"mslug3b6", "Metal Slug 6 (bootleg of Metal Slug 3)"},
    {"mslug3fd", "Metal Slug 3 (Fully Decrypted)"},
    {"mslug3h", "Metal Slug 3 (NGH-2560)"},
    {"mslug3n", "Metal Slug 3 (not encrypted)"},
    {"mslug3unity", "Metal Slug 3 Unity (Added Timer Ver. 2021-02-13)"},
    {"mslug3x", "Metal Slug 3X (Complete Collection)"},
    {"mslug4", "Metal Slug 4"},
    {"mslug4fd", "Metal Slug 4 (Fully Decrypted)"},
    {"mslug4h", "Metal Slug 4 (NGH-2630)"},
    {"mslug4unity", "Metal Slug 4 Unity (Added Timer Ver. 2021-01-30)"},
    {"mslug5", "Metal Slug 5"},
    {"mslug5b", "Metal Slug 5 (bootleg)"},
    {"mslug5b2", "Metal Slug 5 (bootleg, set 2)"},
    {"mslug5fd", "Metal Slug 5 (Fully Decrypted)"},
    {"mslug5h", "Metal Slug 5 (NGH-2680)"},
    {"mslug5nd", "Metal Slug 5 (Not Encrypted)"},
    {"mslug5unity", "Metal Slug 5 Unity (Added Timer Ver. 2021-04-23)"},
    {"mslug6", "Metal Slug 6"},
    {"mslugunity", "Metal Slug Unity (Added Timer Ver. 2021-02-05)"},
    {"mslugx", "Metal Slug X - Super Vehicle-001"},
    {"mslugxunity", "Metal Slug X - Super Vehicle-001 Unity (Added Timer Ver. 2021-01-23)"},
    ...
    {"mwalkbl2", "Michael Jackson's Moonwalker (bootleg)"},
