...
const lookup_internal_name lookup_a_table[] = {
    ...
    {"akatana", "Akai Katana (2010/ 8/13 MASTER VER.)"},
    ...
    {"alienres", "Alien Rescue (Homebrew, Test Build July 2019)"},
    ...
    {"amazoneo", "Soldier Girl Amazon Neo"},
    ...
    {"aof3bh", "Art of Fighting 3 - The Path of the Warrior / Art of Fighting - Ryuuko no Ken Gaiden (Enable Hidden "
               "Characters V2)"},
    ...
    {"ark1balla", "Arkanoid (bootleg with MCU, harder, alt)"},
    ...
    {"arkanoidjbla", "Arkanoid (bootleg with MCU, alt)"},
    ...
    {"armchmp2", "Arm Champs II (ver 2.7)"},
    {"armchmp2o", "Arm Champs II (ver 1.7)"},
    {"armchmp2o2", "Arm Champs II (ver 2.6)"},
