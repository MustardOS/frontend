...
const lookup_internal_name lookup_n_table[] = {
    ...
    {"nbagold",
     "SportStation: NBA Showtime NBA on NBC Gold Edition (ver 3.0, Feb 18 2000) / NFL Blitz 2000 Gold Edition"},
    ...
    {"nbanfl", "SportStation: NBA Showtime NBA on NBC (ver 2.1, Sep 22 1999) / NFL Blitz 2000 Gold Edition (ver 1.5, "
               "Sep 22 1999)"},
    ...
    {"ngem2k", "NGEM2K (beta 2006-01-18)"},
    {"ngfrog", "Frog Feast (Neo Geo)"},
    {"ngftdemo", "NGF Transparency Demo"},
    {"ngmontst", "Monitor Test Patterns Tool (v1.3)"},
