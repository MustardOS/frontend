...
const lookup_internal_name lookup_c_table[] = {
    ...
    {"cps3bootao2",
     "CPS3 Multi-game bootleg for dead security cart (oldest) (New Generation, 2nd Impact and 3rd Strike only)"},
    {"cps3booto", "CPS3 Multi-game bootleg for HD6417095 type SH2 (older)"},
    {"cps3booto2", "CPS3 Multi-game bootleg for HD6417095 type SH2 (oldest) (New Generation, 3rd Strike, JoJo's "
                   "Venture, JoJo's Bizarre Adventure and Red Earth only)"},
