...
const lookup_internal_name lookup_p_table[] = {
    ...
    {"pangbold2", "Pang (bootleg, set 5)"},
    {"pangbold3", "Pang (bootleg, set 6)"},
    ...
    {"pbobble3rc", "Puzzle Bobble 3 Recarbonated"},
    ...
    {"pgemeni", "P-GeMeni (060123)"},
    {"pgm3in1", "Shanliang San He Yi (Flash 3-in-1) (V102 08/23/04 13:03:26)"},
    {"pgm3in1c100", "Shanliang San He Yi (Flash 3-in-1) (V100 07/13/04 12:09:20)"},
    {"pgmdemo", "Chaos (PGM Demo)"},
    {"pgmfrog", "Frog Feast (PGM)"},
    ...
    {"photoy2k102j", "Photo Y2K / Chaoji Bi Yi Bi / Dajia Lai Zhao Cha / Real and Fake (ver. 102, Japanese Board)"},
    {"photoy2k103j", "Photo Y2K / Chaoji Bi Yi Bi / Dajia Lai Zhao Cha / Real and Fake (ver. 103, Japanese Board)"},
    {"photoy2k104", "Photo Y2K / Chaoji Bi Yi Bi / Dajia Lai Zhao Cha / Real and Fake (ver. 104)"},
    {"phozon", "Phozon (Japan)"},
    ...
    {"powerinsc", "Power Instinct (USA, bootleg set 3)"},
    ...
    {"prehislea", "Prehistoric Isle in 1930 (World, set 2)"},
    ...
    {"proneon", "Project Neon (Caravan Edition, prealpha v0.4.19)"},
    ...
    {"punisherb", "The Punisher (bootleg)"},
    ...
    {"puzlstara", "Puzzle Star / Mohuan Xingzuo (ver. 100MG, 09/20/99 build)"},
    ...
    {"pwrinst2k", "Power instinct 2 (Korea, ver. 94/04/08)"},
    {"pwrkick", "Power Kick (Japan)"},
    {"py2k2", "Photo Y2K 2"},
    {"py2k2100", "Photo Y2K 2 / Chaoji Bi Yi Bi 2 / Dajia Lai Zhao Cha 2 / Real and Fake 2 Photo Y2K (ver. 100, "
                 "Japanese Board)"},
    {"pyros", "Pyros (US)"},
