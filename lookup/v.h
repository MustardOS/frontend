...
const lookup_internal_name lookup_v_table[] = {
    ...
    {"vliner", "V-Liner"},
    {"vliner53", "V-Liner (v0.53)"},
    {"vliner54", "V-Liner (v0.54)"},
    {"vliner6e", "V-Liner (v0.6e)"},
    {"vliner7e", "V-Liner (v0.7e)"},
    ...
    {"vscastlevania", "VS. Castlevania"},
    {"vsclucluland", "VS. Clu Clu Land"},
    {"vsdrmario", "VS. Dr. Mario"},
    {"vsduckhunt", "VS. Duck Hunt"},
    {"vsexcitebike", "VS. Excitebike"},
    {"vsfdf", "Vs. Freedom Force"},
    {"vsfreedomforce", "VS. Freedom Force"},
    {"vsfrombelow", "VS. From Below (HB, v0.10)"},
    {"vsgongf", "VS Gong Fight"},
    {"vsgoonies", "VS. Goonies, The"},
    {"vsgradius", "VS. Gradius"},
    {"vsgradus", "Vs. Gradius"},
    {"vsgshoe", "Vs. Gumshoe"},
    {"vsgumshoe", "VS. Gumshoe"},
    {"vshogansalley", "VS. Hogan's Alley"},
    {"vshoot", "J-League Soccer V-Shoot"},
    {"vsiceclimber", "VS. Ice Climber"},
    {"vsmachrider", "VS. Mach Rider"},
    {"vsmahjng", "Vs. Mahjang (Japan)"},
    {"vsmightybomjack", "VS. Mighty Bomb Jack"},
    ...
    {"vsninjajkun", "VS. Ninja Jajamaru-kun"},
    {"vspinbal", "Vs. Pinball"},
    {"vspinbalj", "Vs. Pinball (Japan, set PN3 B)"},
    {"vspinball", "VS. Pinball"},
    {"vspinblj", "Vs. Pinball (Japan)"},
    {"vsplatoon", "VS. Platoon"},
    {"vspsx", "Video System PSX"},
    {"vsraidbbay", "VS. Raid on Bungling Bay"},
    {"vsrbibbal", "VS. Atari RBI Baseball"},
    {"vsskykid", "Vs. Super SkyKid"},
    {"vsslalom", "Vs. Slalom"},
    {"vssmb", "VS. Super Mario Bros"},
    {"vssmgolf", "VS. Stroke & Match Golf"},
    {"vssmgolfla", "VS. Stroke & Match Golf Ladies"},
    {"vssoccer", "Vs. Soccer"},
    {"vssoccera", "Vs. Soccer (set SC4-3 ?)"},
    {"vssoccerj", "Vs. Soccer (Japan)"},
    {"vsstarluster", "VS. Star Luster"},
    {"vssuperskykid", "VS. Super Sky Kid"},
    {"vssuperxevious", "VS. Super Xevious - Gump no Nazo"},
    {"vstars", "Video Stars"},
    {"vstennis", "Vs. Tennis"},
