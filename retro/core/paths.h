...
#define RETRO_OPT_PATH RETRO_SHARE_PATH "coreopt"
#define RETRO_SET_PATH RETRO_SHARE_PATH "settings"
#define RETRO_HSH_PATH RETRO_SHARE_PATH "hash"
#define RETRO_EXT_PATH RETRO_SHARE_PATH "extract"
