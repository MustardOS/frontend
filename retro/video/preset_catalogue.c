...
void preset_catalogue_init(void) {
    ...
    author_definition = (submenu_def) {
        ...
        .row_count = 0,
        .help_title = lang.muxretro.catalogue_screen.downloads,
        .help_all = lang.muxretro.help.screen.catalogue_author,
    ...
    item_definition = (submenu_def) {
        ...
        .row_count = 0,
        .help_title = lang.muxretro.catalogue_screen.downloads,
        .help_all = lang.muxretro.help.screen.catalogue_item,
