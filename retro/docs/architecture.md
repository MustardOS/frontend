...
| File                        | Purpose                                                                                                                                                                                                                                           |
|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `main.c`                    | Entry point: single-instance runtime lock, startup sequence, main loop (frame batching, pacing, runahead hook), shutdown.                                                                                                                         |
...
| File                                        | Purpose                                                                                                                                                                                                                                                                                                       |
|---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `video.c`                                   | SDL2 texture pipeline: raw frame upload/conversion, optional Anti-Flicker history/confidence storage, all scaling modes (including native whole-pixel Integer scaling, Fit Screen and the Shimmer Fix snap), rotation, mirroring. Dispatches CPU texture filters to `filters/` rather than implementing them. |
| `interframe_blend.c`                        | Pixel-format-safe A/B/A temporal flicker detection, short per-pixel persistence, and selective blending for software-rendered frames.                                                                                                                                                                         |
| `ui_imagecorrections.c`                     | Image Corrections child page containing Shimmer Fix and software-only Anti-Flicker controls.                                                                                                                                                                                                                  |
...
| `preset_catalogue.c` / `preset_catalogue.h` | Shared online filter/shader manifest, integrity verification, install state and atomic publication.                                                                                                                                                                                                           |
...
| `hotkeys.c` / `hotkeys.h`                 | Configurable MENU combo dispatcher, including press and hold speed modes (see [Hotkeys](settings.md#hotkeys)).                                                                                                                                                                                   |
...
| `deck.c` / `deck.h`                       | Ketchup Deck layout library - named, reusable layouts in `save/pickles/deck/`, with deferred saving (see [Ketchup Deck](ketchup-deck.md)).                                                                                                                                                       |
...
| `ui_inputport.c`                          | Per-port screen, rows built to suit the port - Controller, then either Core Device and Stick to D-Pad, or the three Ketchup Deck rows, then Button Mapping, Macros and Reset Port.                                                                                                               |
