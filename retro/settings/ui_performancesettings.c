...
enum { row_fps_limit = 0, row_frame_delay, row_count };

static const char *row_labels[row_count] = {
    lang.muxretro.settings_screen.fps_limit, lang.muxretro.settings_screen.frame_delay
};

static const char *row_glyphs[row_count] = {"fpslimit", "framedelay"};
...
static void build_performance_row(const int index) {
...
static void performance_nav(const int force) {
...
static void close_performance(void) {
    active = 0;
...
void performance_menu_init(void) {
    ...
    dialogue_init(
        &save_dlg, &theme, ui_screen, lang.muxretro.save.performance_title, lang.muxretro.save.performance_desc,
        save_options, 4, lang.generic.select, lang.generic.cancel
    );
}
