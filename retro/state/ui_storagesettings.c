...
static void build_storage_row(const int index) {
...
static void storage_nav(const int force) {
...
void storage_menu_init(void) {
    ...
    dialogue_init(
        &save_dlg, &theme, ui_screen, lang.muxretro.save.storage_title, lang.muxretro.save.storage_desc, save_options,
