...
void init_muxcharge(void) {
    ...
    lv_obj_set_style_bg_color(ui_pnlWall_charge, lv_color_hex(theme.CHARGER.BACKGROUND), MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_bg_opa(ui_pnlWall_charge, theme.CHARGER.BACKGROUND_ALPHA, MU_OBJ_MAIN_DEFAULT);
    ...
    lv_obj_set_style_radius(ui_pnlCharge_charge, 0, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_bg_color(ui_pnlCharge_charge, lv_color_hex(theme.CHARGER.BACKGROUND), MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_bg_opa(ui_pnlCharge_charge, theme.CHARGER.BACKGROUND_ALPHA, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_border_width(ui_pnlCharge_charge, 0, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_pad_row(ui_pnlCharge_charge, 15, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_pad_column(ui_pnlCharge_charge, 30, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_align(ui_pnlCharge_charge, LV_TEXT_ALIGN_CENTER, MU_OBJ_MAIN_DEFAULT);
    ...
    lv_obj_set_style_text_opa(ui_lblCapacity_charge, theme.CHARGER.TEXT_ALPHA, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_align(ui_lblCapacity_charge, LV_TEXT_ALIGN_CENTER, MU_OBJ_MAIN_DEFAULT);
    ...
    lv_obj_set_style_text_opa(ui_lblVoltage_charge, theme.CHARGER.TEXT_ALPHA, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_align(ui_lblVoltage_charge, LV_TEXT_ALIGN_CENTER, MU_OBJ_MAIN_DEFAULT);
    ...
    lv_obj_set_style_text_opa(ui_lblBoot_charge, theme.CHARGER.TEXT_ALPHA, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_align(ui_lblBoot_charge, LV_TEXT_ALIGN_CENTER, MU_OBJ_MAIN_DEFAULT);
