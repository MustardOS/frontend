...
lv_obj_t *ui_pnlThemeResolution_hdmi;
...
lv_obj_t *ui_lblThemeResolution_hdmi;
...
lv_obj_t *ui_icoThemeResolution_hdmi;
...
lv_obj_t *ui_droThemeResolution_hdmi;
...
void init_muxhdmi(lv_obj_t *ui_pnlContent) {
    ...
    ui_pnlThemeResolution_hdmi = lv_obj_create(ui_pnlContent);
    ...
    ui_lblThemeResolution_hdmi = lv_label_create(ui_pnlThemeResolution_hdmi);
    lv_label_set_text(ui_lblThemeResolution_hdmi, "");
    ...
    ui_icoThemeResolution_hdmi = lv_img_create(ui_pnlThemeResolution_hdmi);
    ...
    ui_droThemeResolution_hdmi = lv_dropdown_create(ui_pnlThemeResolution_hdmi);
    lv_dropdown_clear_options(ui_droThemeResolution_hdmi);
    lv_obj_set_style_text_opa(ui_droThemeResolution_hdmi, 0, LV_PART_INDICATOR | LV_STATE_DEFAULT);
