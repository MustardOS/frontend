...
static const module_entry modules[] = {
    ...
    {"language", "tweakgen", "muxlanguage", muxlanguage_main, NULL},
    ...
    {"webcode", "connect", "muxwebcode", muxwebcode_main, NULL},
    ...
    {"sort", "custom", "muxsort", muxsort_main, NULL},
    {"order", "explore", "muxorder", muxorder_main, NULL},
