...
static void save_tweak_options() {
    ...
    int idx_shutdown = map_drop_down_to_value(lv_dropdown_get_selected(ui_droShutdown_power), shutdown_values, SHUTDOWN_COUNT, -2);
    int idx_battery = map_drop_down_to_value(lv_dropdown_get_selected(ui_droBattery_power), battery_values, BATTERY_COUNT, 25);
