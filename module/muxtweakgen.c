...
#define UI_COUNT 7
    ...
    INIT_NAV_ITEM(tweakgen, RTC, lang.MUXTWEAKGEN.DATETIME, "clock", NULL, 0);
    INIT_NAV_ITEM(tweakgen, HDMI, lang.MUXTWEAKGEN.HDMI, "hdmi", NULL, 0);
    INIT_NAV_ITEM(tweakgen, Advanced, lang.MUXTWEAKGEN.ADVANCED, "advanced", NULL, 0);
    INIT_NAV_ITEM(tweakgen, Brightness, lang.MUXTWEAKGEN.BRIGHT, "brightness", NULL, 0);
    INIT_NAV_ITEM(tweakgen, Volume, lang.MUXTWEAKGEN.VOLUME, "volume", NULL, 0);
    INIT_NAV_ITEM(tweakgen, Colour, lang.MUXTWEAKGEN.TEMP, "colour", NULL, 0);
    INIT_NAV_ITEM(tweakgen, Startup, lang.MUXTWEAKGEN.STARTUP.TITLE, "startup", startup_options, 6);
