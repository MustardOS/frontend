...
#define UI_COUNT 19
    ...
    INIT_NAV_ITEM(tweakadv, Accelerate, lang.MUXTWEAKADV.SPEED, "accelerate", NULL, 0);
    INIT_NAV_ITEM(tweakadv, Swap, lang.MUXTWEAKADV.SWAP.TITLE, "swap", swap_options, 2);
    INIT_NAV_ITEM(tweakadv, Thermal, lang.MUXTWEAKADV.THERMAL, "thermal", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, Volume, lang.MUXTWEAKADV.VOLUME.TITLE, "volume", volume_options, 4);
    INIT_NAV_ITEM(tweakadv, Brightness, lang.MUXTWEAKADV.BRIGHT.TITLE, "brightness", brightness_options, 4);
    INIT_NAV_ITEM(tweakadv, Offset, lang.MUXTWEAKADV.OFFSET, "offset", NULL, 0);
    INIT_NAV_ITEM(tweakadv, Passcode, lang.MUXTWEAKADV.LOCK, "lock", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, LED, lang.MUXTWEAKADV.LED, "led", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, Theme, lang.MUXTWEAKADV.RANDOM, "theme", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, RetroWait, lang.MUXTWEAKADV.NET_WAIT, "retrowait", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, State, lang.MUXTWEAKADV.STATE, "state", state_options, 2);
    INIT_NAV_ITEM(tweakadv, Verbose, lang.MUXTWEAKADV.VERBOSE, "verbose", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, Rumble, lang.MUXTWEAKADV.RUMBLE.TITLE, "rumble", rumble_options, 7);
    INIT_NAV_ITEM(tweakadv, UserInit, lang.MUXTWEAKADV.USER_INIT, "userinit", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, DPADSwap, lang.MUXTWEAKADV.DPAD, "dpadswap", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, Overdrive, lang.MUXTWEAKADV.OVERDRIVE, "overdrive", disabled_enabled, 2);
    INIT_NAV_ITEM(tweakadv, Swapfile, lang.MUXTWEAKADV.SWAPFILE, "swapfile", NULL, 0);
    INIT_NAV_ITEM(tweakadv, Zramfile, lang.MUXTWEAKADV.ZRAMFILE, "zramfile", NULL, 0);
    INIT_NAV_ITEM(tweakadv, CardMode, lang.MUXTWEAKADV.TUNING, "cardmode", cardmode_options, 2);
