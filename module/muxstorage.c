...
static void init_navigation_group() {
    ...
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.CATALOGUE, "catalogue", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.FRIENDLY, "name", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.RA_SYSTEM, "retroarch", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.RA_CONFIG, "config", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.ASSIGNED, "core", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.COLLECTION, "collecion", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.HISTORY, "history", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.MUSIC, "music", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.SAVE, "save", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.SCREENSHOT, "screenshot", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.PACKAGE.THEME, "theme", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.PACKAGE.CATALOGUE, "pack-catalogue", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.PACKAGE.RA_CONFIG, "pack-config", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.PACKAGE.BOOTLOGO, "pack-bootlogo", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.LANGUAGE, "language", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.NET_PROFILE, "network", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.SYNCTHING, "syncthing", "");
    INIT_VALUE_ITEM(storage, BIOS, lang.MUXSTORAGE.USER_INIT, "userinit", "");
