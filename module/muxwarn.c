...
int main(void) {
    ...
    lv_obj_set_style_text_font(ui_lblHeader, header_font, MU_OBJ_MAIN_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_lblMessage, lv_color_hex(0xDDA200), MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_align(ui_lblMessage, LV_TEXT_ALIGN_CENTER, MU_OBJ_MAIN_DEFAULT);
    lv_obj_set_style_text_color(ui_lblMessage, lv_color_hex(0xF8E008), MU_OBJ_MAIN_FOCUS);
