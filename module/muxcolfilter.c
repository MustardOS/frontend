...
void muxcolfilter_main(const int auto_assign, const char *name, const char *dir, const char *sys, const int app) {
    (void) auto_assign;
    ...
    dialogue_init_assign_scope(
        &assign_dlg, &theme, ui_screen, lang.muxoption.colfilter, is_dir, is_app, at_base(rom_dir, MAIN_ROM_DIR),
    ...
    orientation_introduce(mux_module, lang.muxcolfilter.title, lang.muxcolfilter.overview);
