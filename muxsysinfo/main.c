...
void update_system_info() {
    ...
    sprintf(battery_cap, "%d%% (Offset: %d)",
            ...
            get_ini_int(muos_config, "tweak", "offset", LABEL) - 50);
                        ...
                        if (ev.code == ABS_HAT0X || ev.code == ABS_Z) {
                            switch (ev.value) {
                                ...
                                case -1:
                                    ...
                                    nav_prev(ui_group_value, ITEM_SKIP);
                                ...
                                case 4096:
                                    ...
                                    nav_next(ui_group_value, ITEM_SKIP);
...
int main(int argc, char *argv[]) {
    ...
    load_font(basename(argv[0]), ui_scrSysInfo);
