...
void ui_scrDevice_screen_init(void)
{
    ...
    lv_obj_set_width(ui_icoRG28XX, 640);
    ...
    lv_obj_set_width(ui_icoRG35XXH, 640);
    ...
    lv_obj_set_width(ui_icoRG35XXPLUS, 640);
    ...
    ui_pnlProgressBrightness = lv_obj_create(ui_scrDevice);
    ...
    ui_pnlProgressVolume = lv_obj_create(ui_scrDevice);
