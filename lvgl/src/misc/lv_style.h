 ...
 * @return 1: the property was found and removed; 0: the property wasn't found
 */
...
lv_style_get_prop_inlined(const lv_style_t *style, lv_style_prop_t prop, lv_style_value_t *value) {
 ...
 * @param style pointer to a style
 * @return 1 if the style is empty
 */
 ...
 * @param flag Flag
 * @return 1 if the flag is set for this property
 */
static inline int lv_style_prop_has_flag(lv_style_prop_t prop, uint8_t flag) {
