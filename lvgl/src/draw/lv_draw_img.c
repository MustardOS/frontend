...
int g_glyph_shadow_enabled = 0;
lv_color_t g_glyph_shadow_colour_default;
lv_opa_t g_glyph_shadow_alpha_default = LV_OPA_COVER;
int16_t g_glyph_shadow_x_offset_default = 2;
int16_t g_glyph_shadow_y_offset_default = 2;
lv_color_t g_glyph_shadow_colour_focus;
lv_opa_t g_glyph_shadow_alpha_focus = LV_OPA_50;
int16_t g_glyph_shadow_x_offset_focus = 2;
int16_t g_glyph_shadow_y_offset_focus = 2;
...
void lv_glyph_shadow_set(int enabled,
    ...
    g_glyph_shadow_x_offset_default = def_x;
    g_glyph_shadow_y_offset_default = def_y;
    g_glyph_shadow_colour_focus = focus_colour;
    g_glyph_shadow_alpha_focus = focus_alpha;
    g_glyph_shadow_x_offset_focus = focus_x;
    g_glyph_shadow_y_offset_focus = focus_y;
}
...
void lv_draw_img_dsc_init(lv_draw_img_dsc_t *dsc) {
    ...
    dsc->effect_type = (int8_t) g_glyph_shadow_enabled;
    dsc->effect_color = g_glyph_shadow_colour_default;
    dsc->effect_opa = g_glyph_shadow_alpha_default;
    dsc->effect_x_offset = (int8_t) g_glyph_shadow_x_offset_default;
    dsc->effect_y_offset = (int8_t) g_glyph_shadow_y_offset_default;
}
...
void lv_draw_img(lv_draw_ctx_t *draw_ctx, const lv_draw_img_dsc_t *dsc, const lv_area_t *coords, const void *src) {
    ...
    if (dsc->effect_type > 0) {
        ...
        shadow_coords.x2 += dsc->effect_x_offset;
        shadow_coords.y1 += dsc->effect_y_offset;
        shadow_coords.y2 += dsc->effect_y_offset;
        lv_draw_img(draw_ctx, &shadow_dsc, &shadow_coords, src);
    }
