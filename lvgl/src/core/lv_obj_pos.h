 ...
 * @param obj       pointer to an object
 * @return          1: the size has been changed
 */
int lv_obj_refr_size(struct _lv_obj_t *obj);
 ...
 * @return 1:    positioned by a layout; 0: not positioned by a layout
 */
int lv_obj_is_layout_positioned(const struct _lv_obj_t *obj);
...
void lv_obj_align_to(
    struct _lv_obj_t *obj, const struct _lv_obj_t *base, lv_align_t align, lv_coord_t x_ofs, lv_coord_t y_ofs
);
 ...
 * @param obj       pointer to an object
 * @return          0: nothing happened; 1: refresh happened
 */
int lv_obj_refresh_self_size(struct _lv_obj_t *obj);

void lv_obj_refr_pos(struct _lv_obj_t *obj);

void lv_obj_move_to(struct _lv_obj_t *obj, lv_coord_t x, lv_coord_t y);

void lv_obj_move_children_by(struct _lv_obj_t *obj, lv_coord_t x_diff, lv_coord_t y_diff, int ignore_floating);
 ...
 */
void lv_obj_transform_point(const struct _lv_obj_t *obj, lv_point_t *p, int recursive, int inv);
 ...
 * @param inv           do the inverse of the transformation (-angle and 1/zoom)
 */
void lv_obj_get_transformed_area(const struct _lv_obj_t *obj, lv_area_t *area, int recursive, int inv);
 ...
 * @return 1     visible; 0 not visible (hidden, out of parent, on other screen, etc)
 */
int lv_obj_area_is_visible(const struct _lv_obj_t *obj, lv_area_t *area);
 ...
 * @return      1: visible; 0 not visible (hidden, out of parent, on other screen, etc)
 */
int lv_obj_is_visible(const struct _lv_obj_t *obj);
 ...
 * @return          1: if the object is considered under the point
 */
int lv_obj_hit_test(struct _lv_obj_t *obj, const lv_point_t *point);
