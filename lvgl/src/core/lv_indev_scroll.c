...
void _lv_indev_scroll_throw_handler(_lv_indev_proc_t *proc) {
    ...
    if (proc->types.pointer.scroll_dir == LV_DIR_VER) {
        ...
        if (align_y == LV_SCROLL_SNAP_NONE) {
            ...
            proc->types.pointer.scroll_throw_vect.y = elastic_diff(scroll_obj, proc->types.pointer.scroll_throw_vect.y,
                                                                   st, sb,
                                                                   LV_DIR_VER);
        ...
        if (align_x == LV_SCROLL_SNAP_NONE) {
            ...
            proc->types.pointer.scroll_throw_vect.x = elastic_diff(scroll_obj, proc->types.pointer.scroll_throw_vect.x,
                                                                   sl, sr,
                                                                   LV_DIR_HOR);
