...
typedef void (*lv_group_focus_cb_t)(const struct _lv_group_t *);
typedef void (*lv_group_edge_cb_t)(struct _lv_group_t *, int);
...
/**
 * Set a default group. New object are added to this group if it's enabled in their class with `add_to_def_group = 1`
 ...
 * @param group     pointer to a group
 * @param en        1: freeze, 0: release freezing (normal mode)
 */
void lv_group_focus_freeze(lv_group_t *group, int en);
 ...
 * @param edit          1: edit mode; 0: navigate mode
 */
void lv_group_set_editing(lv_group_t *group, int edit);

/**
 * Set whether focus next/prev will allow wrapping from first->last or last->first object.
 * @param group         pointer to group
 * @param               en 1: wrapping enabled; 0: wrapping disabled
 */
void lv_group_set_wrap(lv_group_t *group, int en);
 ...
 * @param group         pointer to group
 * @return              1: edit mode; 0: navigate mode
 */
int lv_group_get_editing(const lv_group_t *group);
 ...
 * @param               en 1: wrapping enabled; 0: wrapping disabled
 */
int lv_group_get_wrap(lv_group_t *group);
