...
static inline int lv_obj_get_style_bg_img_tiled(const struct _lv_obj_t *obj, uint32_t part) {
...
static inline int lv_obj_get_style_border_post(const struct _lv_obj_t *obj, uint32_t part) {
...
static inline int lv_obj_get_style_line_rounded(const struct _lv_obj_t *obj, uint32_t part) {
...
static inline int lv_obj_get_style_arc_rounded(const struct _lv_obj_t *obj, uint32_t part) {
...
static inline int lv_obj_get_style_clip_corner(const struct _lv_obj_t *obj, uint32_t part) {
...
void lv_obj_set_style_bg_img_tiled(struct _lv_obj_t *obj, int value, lv_style_selector_t selector);
...
void lv_obj_set_style_border_post(struct _lv_obj_t *obj, int value, lv_style_selector_t selector);
...
void lv_obj_set_style_line_rounded(struct _lv_obj_t *obj, int value, lv_style_selector_t selector);
...
void lv_obj_set_style_arc_rounded(struct _lv_obj_t *obj, int value, lv_style_selector_t selector);
...
void lv_obj_set_style_clip_corner(struct _lv_obj_t *obj, int value, lv_style_selector_t selector);
...
void lv_obj_set_style_color_filter_dsc(
    struct _lv_obj_t *obj, const lv_color_filter_dsc_t *value, lv_style_selector_t selector
);
...
void lv_obj_set_style_transition(
    struct _lv_obj_t *obj, const lv_style_transition_dsc_t *value, lv_style_selector_t selector
);
