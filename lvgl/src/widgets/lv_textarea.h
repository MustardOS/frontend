 ...
 * @param obj       pointer to a text area object
 * @param en        1: enable click positions; 0: disable
 */
 ...
 * @param obj       pointer to a text area object
 * @param en        1 or 0 to enable/disable selection mode
 */
 ...
 * @param obj       pointer to a text area object
 * @return          1: enable click positions; 0: disable
 */
 ...
 * @param obj       pointer to a text area object
 * @return          1: password mode is enabled, 0: disabled
 */
 ...
 * @param obj       pointer to a text area object
 * @return          1: one line configuration is enabled, 0: disabled
 */
 ...
 * @param obj       pointer to a text area object
 * @return          1: selection mode is enabled, 0: disabled
 */
