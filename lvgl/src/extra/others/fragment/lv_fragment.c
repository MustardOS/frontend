...
void lv_fragment_del_obj(lv_fragment_t *fragment) {
    ...
    if (states) {
        ...
        states->destroying_obj = 1;
        int cb_removed = lv_obj_remove_event_cb(fragment->obj, cb_delete_assertion);
