...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_num_map[] = {
    1, 1, 1, LV_KEYBOARD_CTRL_BTN_FLAGS | 2, 1, 1, 1, LV_KEYBOARD_CTRL_BTN_FLAGS | 2, 1, 1, 1, 2, 1, 1, 1, 1, 1
};
 ...
 */
void lv_keyboard_set_popovers(lv_obj_t *obj, int en) {
    lv_keyboard_t *keyboard = (lv_keyboard_t *) obj;
 ...
 */
void lv_keyboard_set_map(
    lv_obj_t *obj, lv_keyboard_mode_t mode, const char *map[], const lv_btnmatrix_ctrl_t ctrl_map[]
) {
    kb_map[mode] = map;
 ...
 * @param kb pointer to a Keyboard object
 * @return 1: "popovers" mode is enabled; 0: disabled
 */
int lv_btnmatrix_get_popovers(const lv_obj_t *obj) {
    lv_keyboard_t *keyboard = (lv_keyboard_t *) obj;
