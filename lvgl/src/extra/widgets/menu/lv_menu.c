...
const lv_obj_class_t lv_menu_separator_class = {
    .base_class = &lv_obj_class, .width_def = LV_SIZE_CONTENT, .height_def = LV_SIZE_CONTENT
};
...
const lv_obj_class_t lv_menu_main_header_cont_class = {.base_class = &lv_obj_class};

const lv_obj_class_t lv_menu_sidebar_header_cont_class = {.base_class = &lv_obj_class};
 ...
 *   GLOBAL FUNCTIONS
 **********************/
int lv_menu_item_back_btn_is_root(lv_obj_t *menu, lv_obj_t *obj);
...
int lv_menu_back_btn_is_root(lv_obj_t *menu, lv_obj_t *obj) {
    LV_ASSERT_OBJ(menu, MY_CLASS);
