...
typedef int (*lv_btnmatrix_btn_draw_cb_t)(
    lv_obj_t *btnm, uint32_t btn_id, const lv_area_t *draw_area, const lv_area_t *clip_area
);
 ...
 * @param obj       pointer to a button matrix object
 * @param ctrl      attribute(s) to set from `lv_btnmatrix_ctrl_t`. Values can be ORed.
 * @param en        1: set the attributes; 0: clear the attributes
 */
 ...
 * @return          1: the control attribute is enabled 0: disabled
 */
 ...
 * @return          1: "one check" mode is enabled; 0: disabled
 */
