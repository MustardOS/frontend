 ...
 * @param obj       pointer to a line object
 * @param en        1: enable the y inversion, 0:disable the y inversion
 */
void lv_line_set_y_invert(lv_obj_t *obj, int en);
 ...
 * @param obj       pointer to a line object
 * @return          1: y inversion is enabled, 0: disabled
 */
int lv_line_get_y_invert(const lv_obj_t *obj);
