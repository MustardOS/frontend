...
static inline int lv_draw_mask_is_any(const lv_area_t *a) {
    LV_UNUSED(a);
    return 0;
}
 ...
 */
typedef lv_draw_mask_res_t (*lv_draw_mask_xcb_t)(
    lv_opa_t *mask_buf, lv_coord_t abs_x, lv_coord_t abs_y, lv_coord_t len, void *p
);
 ...
 * @return 1: there is t least 1 draw mask; 0: there are no draw masks
 */
