...
const lv_obj_class_t lv_tileview_class = {
    .constructor_cb = lv_tileview_constructor, .base_class = &lv_obj_class, .instance_size = sizeof(lv_tileview_t)
};
...
static void lv_tileview_tile_constructor(const lv_obj_class_t *class_p, lv_obj_t *obj) {
    ...
    lv_obj_set_pos(
        obj, create_col_id * lv_obj_get_content_width(parent), create_row_id * lv_obj_get_content_height(parent)
    );
