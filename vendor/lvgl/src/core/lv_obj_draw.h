...
typedef struct {
    struct _lv_obj_t *container;
    lv_color_t colour;
    lv_opa_t alpha;
    int8_t x_offset;
    int8_t y_offset;
    lv_color_t colour_focus;
    lv_opa_t alpha_focus;
    int8_t x_offset_focus;
    int8_t y_offset_focus;
} lv_shadow_zone_t;
...
const lv_shadow_zone_t *lv_shadow_zone_find(struct _lv_obj_t *obj);
