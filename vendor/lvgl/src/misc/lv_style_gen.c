...
void lv_style_set_bg_img_tiled(lv_style_t *style, int value) {
    lv_style_value_t v = {.num = (int32_t) value};
...
void lv_style_set_border_post(lv_style_t *style, int value) {
    lv_style_value_t v = {.num = (int32_t) value};
...
void lv_style_set_line_rounded(lv_style_t *style, int value) {
    lv_style_value_t v = {.num = (int32_t) value};
...
void lv_style_set_arc_rounded(lv_style_t *style, int value) {
    lv_style_value_t v = {.num = (int32_t) value};
...
void lv_style_set_clip_corner(lv_style_t *style, int value) {
    lv_style_value_t v = {.num = (int32_t) value};
