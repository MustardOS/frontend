...
typedef struct _lv_fs_drv_t {
    char letter;
    uint16_t cache_size;
    int (*ready_cb)(struct _lv_fs_drv_t *drv);
...
/**
 * Test if a drive is ready or not. If the `ready` function was not initialized `1` will be
 * returned.
 * @param letter    letter of the drive
 * @return          1: drive is ready; 0: drive is not ready
 */
