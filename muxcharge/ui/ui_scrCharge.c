...
void ui_scrCharge_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_pnlCharge, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_width(ui_lblCapacity, LV_SIZE_CONTENT);   /// 1
    ...
    lv_obj_clear_flag(ui_lblCapacity, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
    ...
    lv_obj_set_width(ui_lblHealth, LV_SIZE_CONTENT);   /// 1
    ...
    lv_obj_set_width(ui_lblBoot, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_align(ui_lblBoot, LV_ALIGN_CENTER);
    lv_label_set_long_mode(ui_lblBoot, LV_LABEL_LONG_CLIP);
    lv_label_set_text(ui_lblBoot, "Press POWER button to continue booting...");
