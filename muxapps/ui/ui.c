...
lv_obj_t * ui_lblArchiveManager;
lv_obj_t * ui_lblBackupManager;
lv_obj_t * ui_lblPortMaster;
lv_obj_t * ui_lblRetroArch;
lv_obj_t * ui_lblDinguxCommander;
lv_obj_t * ui_lblGmuMusicPlayer;
lv_obj_t * ui_lblSimpleTerminal;
lv_obj_t * ui_pnlGlyph;
lv_obj_t * ui_icoArchiveManager;
lv_obj_t * ui_icoBackupManager;
lv_obj_t * ui_icoPortMaster;
lv_obj_t * ui_icoRetroArch;
lv_obj_t * ui_icoDinguxCommander;
lv_obj_t * ui_icoGmuMusicPlayer;
lv_obj_t * ui_icoSimpleTerminal;
...
void ui_init(void)
{
    ui_scrApps_screen_init();
    ui____initial_actions0 = lv_obj_create(NULL);
    lv_disp_load_scr(ui_scrApps);
}
