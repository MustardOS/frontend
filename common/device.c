...
#define DEV_BTN_FIELD(input, method)                                                        \
    ...
    DEV_INT_FIELD(device->BOARD.HAS_NETWORK, "board/network")
    DEV_INT_FIELD(device->BOARD.HAS_BLUETOOTH, "board/bluetooth")
    DEV_INT_FIELD(device->BOARD.HAS_PORTMASTER, "board/portmaster")
    DEV_INT_FIELD(device->BOARD.HAS_LID, "board/lid")
    DEV_INT_FIELD(device->BOARD.HAS_HDMI, "board/hdmi")
    DEV_INT_FIELD(device->BOARD.EVENT, "board/event")
    DEV_INT_FIELD(device->BOARD.DEBUGFS, "board/debugfs")
    ...
    DEV_INT_FIELD(device->BOARD.RGB, "led/rgb")
    DEV_INT_FIELD(device->BOARD.STICK, "board/stick")
