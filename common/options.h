...
#define MUX_AUTH          "/tmp/mux_auth"          // Muxpass Config Authorisation
#define MUX_BOOT_AUTH     "/tmp/mux_boot_auth"     // Muxpass Boot Authorisation
#define MUX_LAUNCHER_AUTH "/tmp/mux_launcher_auth" // Muxpass App and Launcher Authorisation
