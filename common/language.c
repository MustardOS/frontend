...
#define SPECIFIC_FIELD(field, string)                    \
    ...
    SPECIFIC_FIELD(lang->MUXTWEAKADV.BRIGHT.LOW, "");
    SPECIFIC_FIELD(lang->MUXTWEAKADV.BRIGHT.HIGH, "");
    ...
    SPECIFIC_FIELD(lang->MUXVISUAL.BOX_ART.ALIGN.T_LEFT, "");
    SPECIFIC_FIELD(lang->MUXVISUAL.BOX_ART.ALIGN.T_MID, "");
    SPECIFIC_FIELD(lang->MUXVISUAL.BOX_ART.ALIGN.T_RIGHT, "");
