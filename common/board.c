...
static const board_info_t board_table[] = {
        {"Generic H36S",       "gcs-h36s",    BOARD_SPECIAL_NONE},
        {"MagicX Zero28",      "mgx-zero28",  BOARD_SPECIAL_NONE},

        {"Anbernic RG28-H",    "rg28xx-h",    BOARD_SPECIAL_NONE},
        {"Anbernic RG34-H",    "rg34xx-h",    BOARD_SPECIAL_NONE},
        {"Anbernic RG34-SP",   "rg34xx-sp",   BOARD_SPECIAL_NONE},

        {"Anbernic RG35-2024", "rg35xx-2024", BOARD_SPECIAL_NONE},
        {"Anbernic RG35-H",    "rg35xx-h",    BOARD_SPECIAL_NONE},
        {"Anbernic RG35-PLUS", "rg35xx-plus", BOARD_SPECIAL_NONE},
        {"Anbernic RG35-PRO",  "rg35xx-pro",  BOARD_SPECIAL_NONE},
        {"Anbernic RG35-SP",   "rg35xx-sp",   BOARD_SPECIAL_NONE},

        {"Anbernic RG40-H",    "rg40xx-h",    BOARD_SPECIAL_NONE},
        {"Anbernic RG40-V",    "rg40xx-v",    BOARD_SPECIAL_NONE},

        {"Anbernic RGCUBE-H",  "rgcubexx-h",  BOARD_SPECIAL_NONE},

        {"Batlexp G350",       "rk-g350-v",   BOARD_SPECIAL_G350},
        {"GKD Pixel 2",        "rk-pixel-2",  BOARD_SPECIAL_NONE},

        {"TrimUI Brick",       "tui-brick",   BOARD_SPECIAL_TUI_BRICK},
        {"TrimUI Smart Pro",   "tui-spoon",   BOARD_SPECIAL_TUI_SPOON},
};
