...
static const cfg_field cfg_fields[] = {
    ...
    {CONF_CONFIG_PATH "settings/advanced", "perf_counters", CFG_OFF(settings.advanced.perf_counters), 0, {.i = 0}, 1,
     0, 1},
    ...
    {CONF_CONFIG_PATH "visual", "elementtransition", CFG_OFF(visual.element_transition), 0, {.i = 0}},
    {CONF_CONFIG_PATH "visual", "bluetooth", CFG_OFF(visual.bluetooth), 0, {.i = 0}},
    {CONF_CONFIG_PATH "visual", "clock", CFG_OFF(visual.clock), 0, {.i = 1}},
    {CONF_CONFIG_PATH "visual", "sortorder", CFG_OFF(visual.sort_order), 0, {.i = 1}},
    {CONF_CONFIG_PATH "visual", "tagorder", CFG_OFF(visual.tag_order), 0, {.i = 1}},
    ...
    {CONF_CONFIG_PATH "visual", "savescreenshot", CFG_OFF(visual.save_screenshot), 0, {.i = 2}, 1, 0, 3},
    {CONF_CONFIG_PATH "visual", "boxarttransition", CFG_OFF(visual.box_art_transition), 0, {.i = 0}},
    ...
    {CONF_CONFIG_PATH "visual", "reducemotion", CFG_OFF(visual.reduce_motion), 0, {.i = 0}, 1, 0, 2},
    ...
    {CONF_CONFIG_PATH "web", "landing", CFG_OFF(web.landing), 0, {.i = 1}, 1, 0, 1},
