...
void apply_theme_list_item(struct theme_config *theme, lv_obj_t * ui_lblItem, char *item_text, bool apply_visual_label, bool enable_scrolling_text, bool is_config_menu);
