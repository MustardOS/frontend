...
void ui_scrApp_screen_init(void)
{
    ui_scrApp = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_scrApp, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_scrApp, lv_color_hex(0x100808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_scrApp, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_scrApp, &ui_font_NotoSans, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_pnlWall = lv_obj_create(ui_scrApp);
    ...
    ui_pnlBox = lv_obj_create(ui_scrApp);
    ...
    ui_pnlContent = lv_obj_create(ui_scrApp);
    ...
    ui_pnlHeader = lv_obj_create(ui_scrApp);
    ...
    ui_pnlFooter = lv_obj_create(ui_scrApp);
    ...
    ui_lblAppMessage = lv_label_create(ui_scrApp);
    ...
    ui_pnlMessage = lv_obj_create(ui_scrApp);
    ...
    ui_pnlHelp = lv_obj_create(ui_scrApp);
    ...
    ui_pnlProgressBrightness = lv_obj_create(ui_scrApp);
    ...
    ui_pnlProgressVolume = lv_obj_create(ui_scrApp);
