...
void apply_theme() {
    ...
    struct big default_elements[] = {
            ...
            {ui_lblAppMessage,   theme.LIST_DEFAULT.TEXT},
    ...
    struct small text_default_alpha_elements[] = {
            ...
            {ui_lblAppMessage,   theme.LIST_DEFAULT.TEXT_ALPHA},
    ...
    struct small font_pad_top_list_elements[] = {
            {ui_lblAppMessage, theme.FONT.LIST_PAD_TOP},
    };
    ...
    struct small font_pad_bottom_list_elements[] = {
            {ui_lblAppMessage, theme.FONT.LIST_PAD_BOTTOM},
    };
