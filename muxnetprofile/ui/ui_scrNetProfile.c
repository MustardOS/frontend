...
// LVGL version: 8.3.6
// Project name: muxnetprofile

#include "ui.h"

void ui_scrNetProfile_screen_init(void)
{
    ui_scrNetProfile = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_scrNetProfile, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_scrNetProfile, lv_color_hex(0x100808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_scrNetProfile, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_scrNetProfile, &ui_font_NotoSans, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_pnlWall = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlBox = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlContent = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlHeader = lv_obj_create(ui_scrNetProfile);
    ...
    lv_label_set_text(ui_lblTitle, "NETWORK PROFILE");
    ...
    ui_pnlFooter = lv_obj_create(ui_scrNetProfile);
    ...
    ui_lblProfileMessage = lv_label_create(ui_scrNetProfile);
    lv_obj_set_width(ui_lblProfileMessage, 640);
    lv_obj_set_height(ui_lblProfileMessage, 28);
    lv_obj_set_align(ui_lblProfileMessage, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblProfileMessage, "Loading Network Profiles...");
    lv_obj_add_flag(ui_lblProfileMessage, LV_OBJ_FLAG_FLOATING);     /// Flags
    lv_obj_set_scroll_dir(ui_lblProfileMessage, LV_DIR_HOR);
    lv_obj_set_style_text_color(ui_lblProfileMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblProfileMessage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_lblProfileMessage, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_lblProfileMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_lblProfileMessage, lv_color_hex(0x100808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui_lblProfileMessage, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_lblProfileMessage, LV_GRAD_DIR_HOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_lblProfileMessage, lv_color_hex(0xA5B2B5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_lblProfileMessage, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui_lblProfileMessage, LV_BORDER_SIDE_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_lblProfileMessage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_lblProfileMessage, lv_color_hex(0xF8E008), LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_text_opa(ui_lblProfileMessage, 255, LV_PART_MAIN | LV_STATE_FOCUSED);

    ui_pnlMessage = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlHelp = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlProgressBrightness = lv_obj_create(ui_scrNetProfile);
    ...
    ui_pnlProgressVolume = lv_obj_create(ui_scrNetProfile);
