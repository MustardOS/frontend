...
void apply_theme() {
    struct big background_elements[] = {
            {ui_scrTheme,       theme.SYSTEM.BACKGROUND},
    ...
    struct small background_alpha_elements[] = {
            {ui_scrTheme,       theme.SYSTEM.BACKGROUND_ALPHA},
    ...
    struct big default_elements[] = {
            ...
            {ui_lblThemeMessage, theme.LIST_DEFAULT.TEXT},
    ...
    struct small text_default_alpha_elements[] = {
            ...
            {ui_lblThemeMessage, theme.LIST_DEFAULT.TEXT_ALPHA},
    ...
    struct small font_pad_top_list_elements[] = {
            {ui_lblThemeMessage, theme.FONT.LIST_PAD_TOP},
    };
    ...
    struct small font_pad_bottom_list_elements[] = {
            {ui_lblThemeMessage, theme.FONT.LIST_PAD_BOTTOM},
    };
