                        ...
                        if (ev.value == 1) {
                            if (msgbox_active) {
                                ...
                                switch (ev.code) {
                                    case JOY_A:
                                        if (element_focused == ui_lblBattery) {
                                            increase_option_value(ui_droBattery, &battery_current, battery_total);
                                        } else if (element_focused == ui_lblNetwork) {
                                            increase_option_value(ui_droNetwork, &network_current, network_total);
                                        } else if (element_focused == ui_lblBluetooth) {
                                            increase_option_value(ui_droBluetooth, &bluetooth_current, bluetooth_total);
                                        } else if (element_focused == ui_lblClock) {
                                            increase_option_value(ui_droClock, &mux_clock_current, mux_clock_total);
                                        } else if (element_focused == ui_lblBoxArt) {
                                            increase_option_value(ui_droBoxArt, &boxart_current, boxart_total);
                                        }
                    ...
                    case EV_ABS:
                        ...
                        if (ev.code == ABS_HAT0Y || ev.code == ABS_RX) {
                            ...
                            switch (ev.value) {
                                ...
                                case -1:
                                    if (element_focused == ui_lblBattery) {
                                        decrease_option_value(ui_droBattery, &battery_current, battery_total);
                                    } else if (element_focused == ui_lblNetwork) {
                                        decrease_option_value(ui_droNetwork, &network_current, network_total);
                                    } else if (element_focused == ui_lblBluetooth) {
                                        decrease_option_value(ui_droBluetooth, &bluetooth_current, bluetooth_total);
                                    } else if (element_focused == ui_lblClock) {
                                        decrease_option_value(ui_droClock, &mux_clock_current, mux_clock_total);
                                    } else if (element_focused == ui_lblBoxArt) {
                                        decrease_option_value(ui_droBoxArt, &boxart_current, boxart_total);
                                    }
                                    play_sound("navigate", nav_sound);
                                    break;
                                case 1:
...
int main(int argc, char *argv[]) {
    ...
    load_font(basename(argv[0]), ui_scrVisual);
